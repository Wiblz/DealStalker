    ...
    <div class="container">
      <div class="row">
        ...
        <s:form action="register" style="display: flex; flex-direction: column; width: 40%; margin: 0 auto;">
          <s:textfield style="font-size: 18px; margin: 5px 5px; height: 20px; text-align: center;" name="customerBean.login" label="Login" />
          <s:textfield style="font-size: 18px; margin: 5px 5px; height: 20px; text-align: center;" name="customerBean.email"  label ="Email"/>
          <s:password style="font-size: 18px; margin: 5px 5px; height: 20px; text-align: center;" name="customerBean.password"  label="Password"  />
          <s:password style="font-size: 18px; margin: 5px 5px; height: 20px; text-align: center;" name="customerBean.repeatedPassword"  label="Repeat Password"  />
